...
- Hills and terrain generation
- Checkpoints
- Airtime tracking
- Unlockable egg and car skins
- Improved suspension
- HUD showing game information

## How to Run
1. Open the project in your code editor.
2. Run the main game file.
3. Use the controls to drive and keep the egg from falling.
